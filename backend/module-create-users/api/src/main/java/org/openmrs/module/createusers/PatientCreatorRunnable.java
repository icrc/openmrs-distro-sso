...
public class PatientCreatorRunnable implements Runnable {
	...
	public PatientCreatorRunnable(Integer patientId, PatientService patientService, Generators generators,
	    List<VisitType> visitTypes, VisitService visitService) {
	...
	public void run() {
		...
		try {
			...
			for (int i = 0; i < visitCount; i++) {
				...
				lastVisit = generators.visitGenerator.createDemoVisit(patient, visitTypes, visitLocation, shortVisit,
